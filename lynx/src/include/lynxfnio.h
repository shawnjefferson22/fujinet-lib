...
#define FUJICMD_OPEN         0x4F  /* O */
#define FUJICMD_CLOSE        0x43  /* C */
#define FUJICMD_READ         0x52  /* R */
#define FUJICMD_WRITE        0x57  /* W */
#define FUJICMD_STATUS       0x53  /* S */
#define FUJICMD_QUERY        0x51  /* Q */
#define FUJICMD_CONTROL      0x41  /* A */
#define FUJICMD_PARSE        0x50  /* P */
#define FUJICMD_TRANSLATION  0x54  /* T */
#define FUJICMD_GET_ERROR    0x45  /* E */
#define FUJICMD_JSON_QUERY   0x81
#define FUJICMD_JSON_PARSE   0x80
